...
- Prioritize primary sources: the actual paper, dataset, announcement, or first-hand reporting. Note when something is contested, uncertain, or based on a single study.
